<template>
  <div :id="ContentId" v-disable="Disable">
    <Modelx TBX :model="model" Property="EventName" Tip="Trạng thái" First Must />
    <Modelx TBX :model="model" Property="EventTime" Tip="Thời điểm" />
    <Modelx TBX :model="model" Property="GeofenceId" Tip="Giới hạn địa lý" />
    <Modelx TBX :model="model" Property="LocationId" Tip="Vị trí" />
  </div>
</template>
