...
namespace NetCore.GpsTrackingModule.Controllers
{
    ...
    [ApiController]
    public partial class EventController : _ControllerGpsTracking
    {
        public EventController(IServiceProvider _ServiceProvider)
            : base(_ServiceProvider)
        {
        }

        [HttpPost]
        public async Task<ActionResult> Save(Event model)
        {
            try
            {
                await Services.Event.Save(pipeline, model);
            }
            catch (Exception ex)
            {
                pipeline.OnError(ex);
        ...
        public async Task<ActionResult> Get(Guid id)
        {
            try
            {
                await Services.Event.Get(pipeline, id);
            }
            catch (Exception ex)
            {
                pipeline.OnError(ex);
        ...
        public async Task<ActionResult> GetPage(PageFilterVM filter)
        {
            try
            {
                await Services.Event.GetPage(pipeline, filter);
            }
            catch (Exception ex)
            {
                pipeline.OnError(ex);
        ...
        public async Task<ActionResult> GetList(ListFilterVM filter)
        {
            try
            {
                await Services.Event.GetList(pipeline, filter);
            }
            catch (Exception ex)
            {
                pipeline.OnError(ex);
        ...
        public async Task<ActionResult> Delete(List<Guid> IDs)
        {
            try
            {
                await Services.Event.Delete(pipeline, IDs);
            }
            catch (Exception ex)
            {
                pipeline.OnError(ex);
