...
namespace NetCore.GpsTrackingModule.Controllers
{
    ...
    [ApiController]
    public partial class ReportLocationController : _ControllerGpsTracking
    {
        public ReportLocationController(IServiceProvider _ServiceProvider)
            : base(_ServiceProvider)
        {
        }

        [HttpPost]
        public async Task<ActionResult> GetPage(ReportLocationFilterVM filter)
        {
            try
            {
